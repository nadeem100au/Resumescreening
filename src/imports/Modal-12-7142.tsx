...
import svgPaths from "./svg-5rnpgnhann";
...
function Frame2() {
  return (
    <motion.div variants={itemVariants} className="content-stretch flex gap-[16px] h-[88px] items-center relative shrink-0 w-full">
...
function FileUploadItemBase() {
  return (
    <motion.div variants={itemVariants} className="bg-white relative rounded-[12px] shrink-0 w-full" data-name="_File upload item base">
...
function TextAndSupportingText2() {
  return (
    <motion.div variants={itemVariants} className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Text and supporting text">
...
function TextWrap({ text }: { text: string }) {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col items-start min-h-px min-w-px relative" data-name="Text wrap">
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[24px] not-italic relative shrink-0 text-[#535862] text-[16px] w-full">{text}</p>
    </div>
  );
}
  ...
  return (
    <div className="content-stretch flex flex-col gap-[16px] items-start relative shrink-0 w-full" data-name="Check items">
      {[
        ...
        <motion.div key={i} variants={itemVariants} className="content-stretch flex gap-[12px] items-start relative shrink-0 w-full" data-name="Check item text">
...
function Frame() {
  return (
    <motion.div variants={itemVariants} className="bg-[#f8f8f8] relative rounded-[15px] shrink-0 w-full">
...
function CheckItems1() {
  return (
    <div className="content-stretch flex flex-col gap-[16px] items-start relative shrink-0 w-full" data-name="Check items">
      <motion.div variants={itemVariants} className="content-stretch flex gap-[12px] items-start relative shrink-0 w-full" data-name="Check item text">
  ...
  return (
    <motion.div variants={itemVariants} className="bg-[#f8f8f8] relative rounded-[15px] shrink-0 w-full">
      <div className="content-stretch flex flex-col gap-[13px] items-start px-[7px] py-[15px] relative size-full">
        ...
        <div className="content-stretch flex flex-col items-start px-[15px] relative w-full gap-[16px]">
          <CheckItems1 />
          <CheckItems2 />
          <CheckItems3 />
        </div>
  ...
  return (
    <div className="relative shrink-0 w-full" data-name="Content">
      <div className="overflow-clip rounded-[inherit] size-full">
        <motion.div variants={staggerContainer} className="content-stretch flex flex-col gap-[10px] items-start pb-[32px] pr-[12px] relative size-full">
...
function InputWithLabel() {
  return (
    <div className="content-stretch flex flex-col gap-[21px] items-start relative shrink-0 w-full" data-name="Input with label">
      <FileUploadItemBase />
      <Content3 />
    </div>
  );
...
function Content() {
  return (
    <motion.div 
      ...
      className="content-stretch flex flex-col gap-[16px] items-start pt-[24px] px-[24px] pb-[24px] relative shrink-0 w-full h-full" data-name="Content">
      <div className="flex w-full items-center justify-between mb-4">
        <div className="flex-1">
          <Frame2 />
        </div>
        <motion.div variants={itemVariants} className="bg-white rounded-[8px] border border-[#d5d7da] shadow-[0px_1px_2px_0px_rgba(10,13,18,0.05)] cursor-pointer hover:bg-gray-50 transition-colors mr-10">
...
function ModalHeader() {
  return (
    <div className="content-stretch flex flex-col items-center relative shrink-0 w-full h-full" data-name="_Modal header">
      <Content />
      <div className="absolute content-stretch flex items-center justify-center overflow-clip p-[8px] right-[2px] rounded-[8px] size-[44px] top-[2px]" data-name="Buttons/Button close X">
        <div className="overflow-clip relative shrink-0 size-[24px] cursor-pointer hover:bg-gray-100 rounded-md transition-colors" data-name="x-close">
...
export default function Modal127142() {
  return (
    <div className="bg-white content-stretch flex flex-col items-center overflow-clip relative rounded-[16px] shadow-[0px_20px_24px_-4px_rgba(10,13,18,0.08),0px_8px_8px_-4px_rgba(10,13,18,0.03),0px_3px_3px_-1.5px_rgba(10,13,18,0.04)] w-[750px] max-w-full" data-name="Modal">
      <ModalHeader />
    </div>
  );
}