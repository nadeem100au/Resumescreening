import svgPaths from "./svg-eyht1udakb";
...
function Main() {
  return (
    <div className="content-stretch flex h-[498px] items-start px-[10px] py-[9px] relative shrink-0 w-[727px] z-[6]" data-name="Main">
      <Content3 />
    </div>
  );
}
...
function LabelWrapper() {
  return (
    <div className="content-stretch flex gap-[2px] items-start relative shrink-0" data-name="Label wrapper">
      <p className="font-['Inter:Medium',sans-serif] font-medium leading-[20px] not-italic relative shrink-0 text-[#535862] text-[14px] whitespace-nowrap">Profile</p>
    </div>
  );
}
...
function LabelWrapper1() {
  return (
    <div className="content-stretch flex gap-[2px] items-start relative shrink-0" data-name="Label wrapper">
      <p className="font-['Inter:Medium',sans-serif] font-medium leading-[20px] not-italic relative shrink-0 text-[#535862] text-[14px] whitespace-nowrap">Must have skills</p>
    </div>
  );
}
...
function InputWithLabel1() {
  return (
    <div className="content-stretch flex flex-col gap-[6px] h-[232px] items-start px-[39px] py-[18px] relative shrink-0 w-[730px] z-[3]" data-name="Input with label">
      <LabelWrapper1 />
      <Input7 />
    </div>
  );
...
function LabelWrapper2() {
  return (
    <div className="content-stretch flex gap-[2px] items-start relative shrink-0" data-name="Label wrapper">
      <p className="font-['Inter:Medium',sans-serif] font-medium leading-[20px] not-italic relative shrink-0 text-[#535862] text-[14px] whitespace-nowrap">Good to have skills</p>
    </div>
  );
}
...
function InputWithLabel2() {
  return (
    <div className="content-stretch flex flex-col gap-[6px] items-start px-[39px] py-[18px] relative shrink-0 w-[730px] z-[2]" data-name="Input with label">
      <LabelWrapper2 />
      <Input8 />
    </div>
  );
...
function LabelWrapper3() {
  return (
    <div className="content-stretch flex gap-[2px] items-start relative shrink-0" data-name="Label wrapper">
      <p className="font-['Inter:Medium',sans-serif] font-medium leading-[20px] not-italic relative shrink-0 text-[#535862] text-[14px] whitespace-nowrap">Raubrics</p>
    </div>
  );
}
...
function InputWithLabel3() {
  return (
    <div className="content-stretch flex flex-col gap-[6px] items-start px-[39px] py-[18px] relative shrink-0 w-[730px] z-[1]" data-name="Input with label">
      <LabelWrapper3 />
      <Input9 />
    </div>
  );
...
function Calendar() {
  return (
    <div className="bg-white content-stretch flex flex-col h-[1315px] isolate items-start overflow-clip relative rounded-bl-[6px] rounded-br-[6px] rounded-tl-[6px] shadow-[0px_1px_2px_0px_rgba(10,13,18,0.05)] shrink-0 w-[743px]" data-name="Calendar">
      <div className="bg-white content-stretch flex flex-col h-[75px] isolate items-start relative shrink-0 w-full z-[7]" data-name="_Calendar header">
        <Content2 />
      </div>
      <Main />
      <div className="bg-white relative shrink-0 w-full z-[5]" data-name="_Calendar header">
...
function Content1() {
  return (
    <div className="content-stretch flex gap-[12px] h-[1315px] items-start pb-[24px] pr-[24px] relative shrink-0" data-name="Content">
      <Calendar />
    </div>
  );
}
...
export default function Manually() {
  return (
    <div className="bg-white content-stretch flex flex-col items-center overflow-clip relative rounded-[16px] shadow-[0px_20px_24px_-4px_rgba(10,13,18,0.08),0px_8px_8px_-4px_rgba(10,13,18,0.03),0px_3px_3px_-1.5px_rgba(10,13,18,0.04)] size-full" data-name="manually 78">
